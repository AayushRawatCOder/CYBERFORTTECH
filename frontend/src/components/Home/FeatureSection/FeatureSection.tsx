...
//             <span>{feature.highlight}</span>
//           </div>
//           {/* // Inside your map loop in DesktopFeaturesView AND inside Card
//           component: */}
//           <div className="icon-wrapper">
//             <div className="rhombus-stack">
//               {/* The CSS now handles the rotation and stacking using nth-child */}
//               <div className="rhombus-layer"></div>
//               <div className="rhombus-layer"></div>
//             </div>
//             <img className="icon" src={feature.Icon} alt={feature.title} />
...
const features: Feature[] = [
  {
    Icon: 'logo/Enterprise-Grade-Cybersecurity.svg',
    title: 'Enterprise-Grade Cybersecurity',
    description: 'We architect resilient digital infrastructures with advanced threat detection, penetration testing, SOC automation, and compliance frameworks.',
    highlight: 'Zero Compromise Security',
    cardClass: 'card-1',
  },
  {
    Icon: 'logo/brain.svg',
    title: 'AI-Driven Intelligence Systems',
    description: 'From anomaly detection and predictive analytics to NLP-based automation, our AI engines power smarter, faster, and more secure decision-making.',
    highlight: 'Smarter, Faster Decisions',
    cardClass: 'card-2',
  },
  {
    Icon: 'logo/chain.svg',
    title: 'Blockchain for Secure Digital Trust',
    description: 'We deploy blockchain technologies that redefine transparency and integrity. Smart contract auditing, decentralized identity, and secure data exchange.',
    highlight: 'Cryptographic Trust',
    cardClass: 'card-3',
  },
  {
  ...
  },
  {
    Icon: 'logo/analysis.svg',
    title: 'CyberFort Labs: Innovation at Core',
    description: 'Our R&D division pushes boundaries in cybersecurity, AI, and blockchain. We prototype new technologies and contribute to open-source.',
    highlight: 'Innovation Hub',
    cardClass: 'card-5',
  },
  {
    Icon: 'logo/chart.svg',
    title: 'Data Science for Risk & Resilience',
    description: 'Our data science models predict vulnerabilities, detect fraud, and deliver real-time analytics through custom dashboards.',
    highlight: 'Strategic Insights',
    cardClass: 'card-6',
  },
];
