...
const SuccessStories: React.FC = () => {
  ...
  const getHighlightedWords = (text: string) => {
    ...
    const wordsToHighlight = [
      'transformative', 'hands-on challenges', 'expert mentorship', 'advanced problem-solving',
      'cybersecurity skills', 'high-quality', 'practical learning experiences', 'extraordinary opportunity',
      'master advanced concepts', 'analytical thinking', 'real-world challenges', 'nurturing talent',
      'dynamic tasks', 'think critically', 'exceptional', 'technical insights', 'strategic guidance',
      'problem-solving', 'cybersecurity expertise', 'game-changer', 'advanced networking concepts',
      'hands-on labs', 'structured curriculum', 'exceptional work', 'deep expertise', 'comprehensive',
      'vulnerability assessment', 'penetration testing', 'modern cybersecurity challenges',
      'fantastic experience', 'hands-on sessions', 'well-structured', 'boosted my confidence'
    ];
  ...
  return (
    <section className={styles.successStories}>
      <div className={styles.container}>
        ...
        {/* Bottom Section: Author Info + Pagination */}
        <div className={styles.footerSection}>
            <div className={styles.authorBlock}>
                ...
                <div className={styles.authorDetails}>
                    ...
                    <p className={styles.authorRole}>{currentTestimonial.designation}</p>
                </div>
            </div>
